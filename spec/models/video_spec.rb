...
describe Video do 
  ...
  describe "search_by_title" do 
    ...
    it "teturn an array of one video for an exact match" do
      futurama = Video.create(title: "Futurama", description: "Space travel!")
      back_to_future = Video.create(title: "Back to Future", description: "Time travel!")
  ...
  describe ".search", :elasticsearch do
    ...
    context "with title" do
      ...
      it "returns no results when there's no match" do
        ...
        expect(Video.search("asdf").records.to_a).to eq []
      end
    ...
    context "with title and description" do
      it "returns an array of many videos based for title and description" do
        star_wars = Fabricate(:video, title: "Star Wars")
